...
export const theme = {
  ...
  colors: {
    ...
    navbar: {
      main: ({ colors }) => colors.primary.light,
      gradient: ({ colors }) => lighten(colors.tonalOffset / 0.85, colors.navbar.main),
      contrastText: ({ colors }) => colors.primary.dark
    },
    footer: {
      main: ({ colors }) => lighten(colors.tonalOffset / 0.85, colors.primary.light),
      contrastText: ({ colors }) => colors.primary.dark
    },
  },
